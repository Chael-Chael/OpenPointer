...
const api: DesktopApi = {
  ...
  readSelection: (req?: ReadSelectionRequest) => ipcRenderer.invoke(OMP_CHANNELS.ReadSelection, req) as Promise<ReadSelectionResponse>,
  insertText: (req: InsertTextRequest) => ipcRenderer.invoke(OMP_CHANNELS.InsertText, req) as Promise<InsertTextResponse>,
