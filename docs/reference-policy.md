...
`D:\cua` is an external computer-use capability. OpenPointer sends context, constraints, and `CuaDirective` hints to agent backends; it does not embed or directly execute CUA in the desktop app.
